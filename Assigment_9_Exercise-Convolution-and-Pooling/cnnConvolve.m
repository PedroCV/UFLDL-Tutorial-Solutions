...
% imageChannels = size(images, 3); WHERE ARE HARD-CODING THIS, BECAUSE RGB
% HAS ONLY THREE CHANNELS!
...
%       feature = zeros(8,8); % You should replace this      
      ...
      % ---- YOUR CODE HERE ----
%       select_img = images(:,:,channel,imageNum);
%       convolvedFeatures = zeros(numFeatures, numImages, imageDim - patchDim + 1, imageDim - patchDim + 1);
%       convolvedFeatures(featureNum,imageNum,:,:) = conv2(select_img,feature,'valid');
